...
<div class="container" style="margin-top:60px;">
    <div class="row">
        <div class="col-lg-12">
            <h1>Edit Skill in <?php echo strtolower($content_language);?></h1>
            <?php echo form_open();?>
            ...
            <?php echo anchor('/admin/skills/index/', 'Cancel','class="btn btn-default btn-lg btn-block"');?>
            <?php echo form_close();?>
        </div>
    </div>
</div>