...
<div class="container" style="margin-top:60px;">
    <div class="row">
        <div class="col-lg-12">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        ...
                        foreach ($langs as $slug => $language) {
                            echo '<li>' . anchor('admin/tag/create/' . $content_type . '/' . $slug, $language['name']) . '</li>';
                        }
                        ?>
                    </ul>
                </div>
            ...
            {
                echo anchor('admin/tag/create/'.$content_type.'/'.$current_lang['slug'],'Add '.$content_type,'class="btn btn-primary"');
            }
            ?>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12" style="margin-top: 10px;">
            ...
            if(!empty($tags))
            {
                ...
                {
                    echo '<tr>';
                    echo '<td>'.$tag_id.'</td><td>'.$skills['title'].'</td>';
                    foreach($langs as $slug=>$language)
                    {
                        echo '<td>';
