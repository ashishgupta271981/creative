...
<div class="container" style="margin-top:60px;">
    <div class="row">
        <div class="col-lg-12">
            <h1>Edit <?php echo $content_type;?> in <?php echo strtolower($content_language);?></h1>
            <?php echo form_open();?>
            <div class="form-group">
                ...
                ?>
                <?php
                echo form_label('Category','parent_id');
			 ...
			 <div class="form-group">
                ...
                ?>
				<input name="tags" id="singleFieldTags" value="<?php echo $tags_list;?>" class="form-control">
            </div>
            <div class="form-group">
                <?php
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        echo form_textarea('content',set_value('content',$translation->content),'class="form-control"');
                        ?>
                    </div>
                    <div class="form-group">
                        <?php
            ...
            ?>
            <?php
            if(($content_type=='page') || ($content_type=='category'))
            {
                ?>
                <div class="form-group">
                    <?php
            ...
            ?>
            <?php echo form_error('blogs_id');?>
            <?php echo form_hidden('content_id',set_value('blogs_id',$translation->blog_id));?>
            ...
            <?php echo anchor('/admin/blogs/index/'.$content_type, 'Cancel','class="btn btn-default btn-lg btn-block"');?>
            <?php echo form_close();?>
        </div>
    </div>
</div>